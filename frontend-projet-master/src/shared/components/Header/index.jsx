  ...
  return (
    <header className="px-3 py-1 h-20 flex flex-row justify-between items-center max-w-8xl mx-auto">
     ...
     <a className="flex items-center">
      ...
      <div style={{ marginRight: '21rem' }}   className="hidden lg:flex items-center space-x-8">
      ...
      <div style={{ marginRight: '20rem' }} className="hidden lg:flex items-center space-x-4">
