    ...
    <div style={{ marginRight: '23rem' }} className="max-w-6xl mx-auto my-5">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white shadow-md rounded-md p-4">
          <img src="/src/assets/parent.png" alt="Ostéopathie" className="w-full h-48 object-cover rounded-md mb-4" />
          <h3 className="text-lg font-semibold mb-2 text-black">Parent and child</h3>
          <p>
        ...
        {/* Card 2 */}
        <div className="bg-white shadow-md rounded-md p-4">
          <img src="/src/assets/perdre.png" alt="Chiropraxie" className="w-full h-48 object-cover rounded-md mb-4" />
          <h3 className="text-lg font-semibold mb-2 text-black">Losing weight</h3>
          <p>
        ...
        {/* Card 3 */}
        <div className="bg-white shadow-md rounded-md p-4">
          <img src="/src/assets/addiction.png" alt="Hypnose" className="w-full h-48 object-cover rounded-md mb-4" />
          <h3 className="text-lg font-semibold mb-2 text-black">Addiction</h3>
          <p>
