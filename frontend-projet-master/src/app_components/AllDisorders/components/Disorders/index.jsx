...
const disorders = () => {
  return (
    <div className={`lg:mr-[20rem] max-w-7xl mx-auto`}>
      ...
      the Alternative medicine helps you get healthy and feel good. 
      They have proven themselves in many areas, 
      and we have deciphered for you the subjects on which they can particularly help you. 
      If you would like to know more about the principles of alternative medicine,.
      </p>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white shadow-md rounded-md p-4">
          <a href="headache">
          <img src="/src/assets/tete.jpg" alt="headache" className="w-full h-48 object-cover rounded-md mb-4" />
          </a>
        ...
        <div className="bg-white shadow-md rounded-md p-4">
          <a href="stress">
          <img src="/src/assets/stress.jpg" alt="stress" className="w-full h-48 object-cover rounded-md mb-4" />
          </a>
        ...
        <div className="bg-white shadow-md rounded-md p-4">
          <a href="stomachaches">
          <img src="/src/assets/ventre.jpg" alt="stomachaches" className="w-full h-48 object-cover rounded-md mb-4" />
          </a>
