    ...
    <div className={`lg:mr-[20rem] max-w-7xl mx-auto mt-10`}>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white shadow-md rounded-md p-4">
          <a href="sophrology">
          <img src="/src/assets/sophrology.jpeg" alt="sophrology" className="w-full h-48 object-cover rounded-md mb-4" />
          </a>
        ...
        <div className="bg-white shadow-md rounded-md p-4">
          <a href="ayurveda">
          <img src="/src/assets/ayurveda2.jpeg" alt="ayurveda" className="w-full h-48 object-cover rounded-md mb-4" />
          </a>
