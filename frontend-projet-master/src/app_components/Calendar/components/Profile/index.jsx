...
const Profile = () => { // Définition du composant Profile
  ...
  return (
    <div className="bg-slate-100 lg:mr-[20rem] max-w-7xl mx-auto mt-10">

      <div className="bg-slate-100 rounded-lg mt-1 shadow-lg px-4 sm:px-6 lg:px-8">
...
const Appointments = ({ appointments }) => { // affichage des rendez-vous
  ...
  <div className="flex flex-col md:flex-row justify-start p-4 md:p-20 max-w-7xl mx-auto">
